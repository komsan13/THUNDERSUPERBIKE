                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-title-desc">รายการเมนูทั้งหมดที่ใช้สำหรับหลังบ้าน คุณสามารถเพิ่มลบแก้ไขหรือจัดการเมนูได้</p>

                                    <div class="mb-3 row">
                                        <div class="col-xl-3">
                                            <select class="form-select" name="status_active" id="status_active">
                                        ...
                                        <div class="col-xl-3">
                                            <input class="form-control" type="text" placeholder="ค้นหา : ชื่อ" name="name" autocomplete="off">
                                        </div>
