                                        ...
                                        <div class="row mb-2">
                                            <div class="col-sm-12 col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <small id="show_detail_th" name="show_detail_th" style="color:red;" hidden><i class="uil uil-exclamation-octagon font-size-16 text-danger me-2"></i> กรุณากรอกข้อมูล</small>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="username">รายละเอียด <span class="badge bg-soft-success font-size-12">EN</span></label>
                                                    <textarea name="detail_en" id="detail_en" class="form-control" cols="30" rows="10">{{$row->detail_en}}</textarea>
                                                    <small id="show_detail_en" name="show_detail_en" style="color:red;" hidden><i class="uil uil-exclamation-octagon font-size-16 text-danger me-2"></i> กรุณากรอกข้อมูล</small>
                                                </div>
                                            </div>
                                        </div>
