                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-title-desc"> คุณสามารถแก้ไขข้อมูลการแปลภาษา ได้จากเมนูนี้</p>
        ...
        $(function() {
            oTable = $('#data-table').DataTable({
                ...
                columns: [ 
                    ...
                    {data: 'action_name',    title :'<center>ชื่อภาษาไทย</center>',    className: 'text-left w20'}, // 1
                    {data: 'action_name_en',    title :'<center>ชื่อภาษาอังกฤษ</center>',    className: 'text-left w20'}, // 2
                    {data: 'updated',    title :'วันที่แก้ไข',    className: 'text-center w10'}, // 3
