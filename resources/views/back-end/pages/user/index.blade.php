                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-title-desc">รายการผู้ดูแลระบบ คุณสามารถเพิ่มลบแก้ไขหรือจัดการเมนูได้</p>
            ...
            oTable = $('#data-table').DataTable({
                ...
                columns: [{
                    ...
                    }, // 0
                    {
                        ...
                        className: 'text-left w15'
                    }, // 1
                    {
                        data: 'action_username',
                        title: '<center>ชื่อผู้ใช้งาน</center>',
                        className: 'text-left w15'
                    }, // 2
                    {
                        data: 'action_role',
                        title: '<center>บทบาทหน้าที่</center>',
                        className: 'text-left w15'
                    }, // 3
                    {
                        data: 'created',
